...
TC_CFLAGS+= -DTCSUPPORT_CPU_MT7510
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7512
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7516
TC_CFLAGS+= -DTCSUPPORT_MIPS_1004K
TC_CFLAGS+= -DTCSUPPORT_MT7510_FE
TC_CFLAGS+= -DTCSUPPORT_ADDR_MAPPING 
TC_CFLAGS+= -DTCSUPPORT_HWNAT_LED
TC_CFLAGS+= -DTCSUPPORT_MULTIWAN
TC_CFLAGS+=-DTCSUPPORT_MT7530_SWITCH_API
TC_CFLAGS+=-DTCSUPPORT_WLAN_SW_RPS
ifneq ($(strip $(TCSUPPORT_TSO_ENABLE)),)
export TCSUPPORT_TSO_ENABLE=1
TC_CFLAGS+= -DTCSUPPORT_TSO_ENABLE
endif
ifneq ($(strip $(TCSUPPORT_TSO_VERIFY)),)
export TCSUPPORT_TSO_VERIFY=1
TC_CFLAGS+= -DTCSUPPORT_TSO_VERIFY
endif
TC_CFLAGS+= -DTCSUPPORT_UART1_ENHANCE
TC_CFLAGS+= -DTCSUPPORT_UART1_RINGBUFFER_KB_SIZE=256
endif
...
TC_CFLAGS+= -DTCSUPPORT_CPU_MT7520
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7521
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7527
TC_CFLAGS+= -DTCSUPPORT_MIPS_1004K
TC_CFLAGS+= -DTCSUPPORT_MT7510_FE
TC_CFLAGS+= -DTCSUPPORT_MT7530_SWITCH_API
TC_CFLAGS+= -DTCSUPPORT_DRIVER_API
...
TC_CFLAGS+= -DTCSUPPORT_CPU_MT7520
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7521
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7580
TC_CFLAGS+= -DTCSUPPORT_MIPS_1004K
TC_CFLAGS+= -DTCSUPPORT_MT7510_FE
TC_CFLAGS+= -DTCSUPPORT_MT7530_SWITCH_API
TC_CFLAGS+= -DTCSUPPORT_DRIVER_API
...
export TCSUPPORT_UCLIBC_VER=933
#for c code include kenrel
TC_CFLAGS+=-DCONFIG_TOOLCHAIN_VER=493 -D__DATE__=\""$(shell date +%Y:%m:%d)"\" -D__TIME__=\""$(shell date +%T)"\" -Wno-builtin-macro-redefined
#for modules c code
...
export TCSUPPORT_GLIBC_VER=220
#for c code include kenrel __GNUC__ __GLIBC__
TC_CFLAGS+=-DCONFIG_GCC_VER=463 -DCONFIG_GLIBC_VER=220
#for modules c code
...
export TCSUPPORT_UCLIBC_VER=933
#for c code include kenrel __GNUC__ __GLIBC__
TC_CFLAGS+=-DCONFIG_GCC_VER=463 -DTCSUPPORT_UCLIBC_VER=933
#for modules c code
...
TC_CFLAGS+=-DTCSUPPORT_SPI_NAND_FLASH_ECC_DMA
TC_CFLAGS+=-DTCSUPPORT_SPI_CONTROLLER_ECC
TC_CFLAGS+=-I$(GLOBAL_INC_DIR)/modules
ifneq ($(strip $(TCSUPPORT_3_18_21_KERNEL)),)
TC_CFLAGS+=-I$(KERNEL_DIR)/drivers/mtd/econet
else
TC_CFLAGS+=-I$(KERNEL_DIR)/drivers/mtd/ralink
endif
endif
...
TC_CFLAGS+=-DTCSUPPORT_QTN_ISOLATION
endif
...
TC_CFLAGS+=-DMT7615_11N -DBBUTOWBU
export TCSUPPORT_WLAN_MT7615_11N
endif
ifneq ($(strip $(TCSUPPORT_WLAN_MT7615D)),)
TC_CFLAGS+=-DMT7615D -DTCSUPPORT_WLAN_MT7615D -DMT7615_11N -DMT7615E -DBBUTOWBU -DTCSUPPORT_DUAL_WLAN -DTCSUPPORT_WLAN_AC
...
TC_CFLAGS+=-DTCSUPPORT_RA_HWNAT $(if $(MODULES_RA_HWNAT_7510_DIR),-I$(MODULES_RA_HWNAT_7510_DIR) -I$(MODULES_ECNT_IGMP_DIR))
endif
...
ifneq ($(strip $(ZYXEL_FLASH_PARTITION_RUN_TIME_CHECK)),)
export ZYXEL_FLASH_PARTITION_RUN_TIME_CHECK
export FLASH_128MB_TCSUPPORT_PARTITIONS_CMDLINE_STR
export FLASH_256MB_TCSUPPORT_PARTITIONS_CMDLINE_STR

TC_CFLAGS+=-DZYXEL_FLASH_PARTITION_RUN_TIME_CHECK
TC_CFLAGS+=-DFLASH_128MB_TCSUPPORT_PARTITIONS_CMDLINE_STR=\"$(FLASH_128MB_TCSUPPORT_PARTITIONS_CMDLINE_STR)\"
TC_CFLAGS+=-DFLASH_256MB_TCSUPPORT_PARTITIONS_CMDLINE_STR=\"$(FLASH_256MB_TCSUPPORT_PARTITIONS_CMDLINE_STR)\"
endif
...
TC_CFLAGS+=-DTCSUPPORT_RESERVEAREA_BLOCK=6
...
TC_CFLAGS+=-DTCSUPPORT_QDMA_WAN_DSCP_NUM=4
export TCSUPPORT_QDMA_WAN_DSCP_NUM=4
endif
ifeq ($(strip $(TCSUPPORT_QDMA_WAN_DSCP_NUM)),8)
TC_CFLAGS+=-DTCSUPPORT_QDMA_WAN_DSCP_NUM=8
...
TC_CFLAGS+=-DTCSUPPORT_WLAN_MT7612_BUILD_IN
...
TC_CFLAGS+=-DTCSUPPORT_WLAN_MT7615_BUILD_IN
...
ifneq ($(strip $(TCSUPPORT_WLAN_BNDSTRG_PLUS)),)
export TCSUPPORT_WLAN_BNDSTRG_PLUS
export TCSUPPORT_WLAN_BNDSTRG_PLUS=1
TC_CFLAGS+=-DTCSUPPORT_WLAN_BNDSTRG_PLUS
export TCSUPPORT_WLAN_BNDSTRG_CUSTOM2
...
ifneq ($(strip $(TCSUPPORT_SPEEDTEST)),)
export TCSUPPORT_SPEEDTEST=1
TC_CFLAGS+=-DTCSUPPORT_SPEEDTEST
endif

ifneq ($(strip $(TCSUPPORT_GRE_TUNNEL_HWNAT)),)
export TCSUPPORT_GRE_TUNNEL_HWNAT=1
TC_CFLAGS+=-DTCSUPPORT_GRE_TUNNEL_HWNAT
endif
...
ifneq ($(strip $(ZYXEL_SUPPORT_ZIGBEE_PROC_FS)),)
export ZYXEL_SUPPORT_ZIGBEE_PROC_FS
export ZYXEL_ZIGBEE_STOPBTL_GPIO
export ZYXEL_ZIGBEE_RESET_GPIO
TC_CFLAGS+=-DZYXEL_SUPPORT_ZIGBEE_PROC_FS
TC_CFLAGS+=-DZYXEL_ZIGBEE_STOPBTL_GPIO=$(ZYXEL_ZIGBEE_STOPBTL_GPIO)
TC_CFLAGS+=-DZYXEL_ZIGBEE_RESET_GPIO=$(ZYXEL_ZIGBEE_RESET_GPIO)
ifneq ($(strip $(ZYXEL_ZIGBEE_STOPBTL_GPIO_ACTIVE_LOW)),)
export ZYXEL_ZIGBEE_STOPBTL_GPIO_ACTIVE_LOW
TC_CFLAGS+=-DZYXEL_ZIGBEE_STOPBTL_GPIO_ACTIVE_LOW
ifneq ($(strip $(ZYXEL_ZIGBEE_RESET_GPIO_ACTIVE_LOW)),)
export ZYXEL_ZIGBEE_RESET_GPIO_ACTIVE_LOW
TC_CFLAGS+=-DZYXEL_ZIGBEE_RESET_GPIO_ACTIVE_LOW
endif
endif
endif
...
ifneq ($(strip $(ZYXEL_USB_OC_ENABLE_GPIO_ACTIVE_LOW)),)
export ZYXEL_USB_OC_ENABLE_GPIO_ACTIVE_LOW
TC_CFLAGS+=-DZYXEL_USB_OC_ENABLE_GPIO_ACTIVE_LOW
endif
...
ifneq ($(strip $(ZYXEL_SUPPORT_2ND_USB_PROTECTION_CIRCUIT)),)
export ZYXEL_SUPPORT_2ND_USB_PROTECTION_CIRCUIT
export ZYXEL_2ND_USB_OC_ENABLE_GPIO
export ZYXEL_2ND_USB_OC_ENABLE_GPIO_ACTIVE_LOW
TC_CFLAGS+=-DZYXEL_SUPPORT_2ND_USB_PROTECTION_CIRCUIT
TC_CFLAGS+=-DZYXEL_2ND_USB_OC_ENABLE_GPIO=$(ZYXEL_2ND_USB_OC_ENABLE_GPIO)
TC_CFLAGS+=-DZYXEL_2ND_USB_OC_ENABLE_GPIO_ACTIVE_LOW
ifneq ($(strip $(ZYXEL_2ND_USB_OC_FLAG_SUPPORT)),)
export ZYXEL_2ND_USB_OC_FLAG_SUPPORT
export ZYXEL_2ND_USB_OC_FLAG_GPIO
TC_CFLAGS+=-DZYXEL_2ND_USB_OC_FLAG_SUPPORT
TC_CFLAGS+=-DZYXEL_2ND_USB_OC_FLAG_GPIO=$(ZYXEL_2ND_USB_OC_FLAG_GPIO)
endif
endif
...
ifneq ($(strip $(ZYXEL_CUSTOMIZE_DEDICATED_WPS_LED)),)
export ZYXEL_CUSTOMIZE_DEDICATED_WPS_LED
TC_CFLAGS+=-DZYXEL_CUSTOMIZE_DEDICATED_WPS_LED
endif
...
ifneq ($(strip $(ZYXEL_KF_TMS)),)
export ZYXEL_KF_TMS
TC_CFLAGS+=-DZYXEL_KF_TMS
endif

ifneq ($(strip $(CONFIG_SAME_FW_FOR_TWO_BOARD)),)
export CONFIG_SAME_FW_FOR_TWO_BOARD
TC_CFLAGS+=-DCONFIG_SAME_FW_FOR_TWO_BOARD
endif

ifneq ($(strip $(ZYXEL_SUPPORT_8021X)),)
export ZYXEL_SUPPORT_8021X
TC_CFLAGS+=-DZYXEL_SUPPORT_8021X
endif

ifneq ($(strip $(ZYXEL_IGMP_SNOOPING_STATUS)),)
export ZYXEL_IGMP_SNOOPING_STATUS=1
TC_CFLAGS+=-DZYXEL_IGMP_SNOOPING_STATUS
endif

ifneq ($(strip $(ZYXEL_DIAGNOSTIC_SPEEDTEST)),)
export ZYXEL_DIAGNOSTIC_SPEEDTEST
TC_CFLAGS+=-DZYXEL_DIAGNOSTIC_SPEEDTEST
endif
